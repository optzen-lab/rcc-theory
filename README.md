# RCC Theory — Resonant Cognitive Circuit (v2.x Series)
*A unified framework of meaning formation, resonance, and semantic closure*
...
1. **Lexical Layer** — surface linguistic expression  
2. **Semantic Layer** — contextual relationships  
3. **Conceptual Layer** — abstract stabilization and closure  
...
RCC is validated through multi-stage experimental designs:

| Stage | Protocol | Objective | Summary |
|--------|-----------|------------|----------|
| **Stage 1** | ORT | Observe natural semantic return | First verification of “semantic gravity.” |
...
## 🧮 Measurement Metrics (v2.1 Addendum)
...
docs/
├── v2.0/
│ ├── RCC_Theory_v2.0_EN(Draft for Review, 2025-11-19).pdf
│ └── RCC_Theory_v2.0_EN(Final for arXiv, 2025-11-27).pdf
├── v2.1/
│ └── RCC_Theory_v2.1_EN(Draft for Review, 2025-11-28).pdf
└── v2.2/ (preparing)
``` 
...
| File | Description |
|------|-------------|
| [overview.md](./docs/overview.md) | RCC overview and theoretical landscape |
| [evolution.md](./docs/evolution.md) | Development history from ORT → PRT → RCC |
...
*End of README — RCC Theory Documentation (v2.x Series)*
